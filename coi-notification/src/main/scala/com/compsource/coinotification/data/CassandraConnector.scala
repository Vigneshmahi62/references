...
object CassandraConnector {
   ...
   */
  private[this] case class CassandraConfig(contact_points: String, native_transport_port: Int, max_local_requests: Int,
                                           max_remote_requests: Int, core_local_connections: Int, max_local_connections: Int,
