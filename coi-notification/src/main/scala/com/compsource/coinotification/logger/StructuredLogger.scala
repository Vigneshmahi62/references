...
import com.compsource.coinotification.CommonObject.{SERVICE_NAME, hostname}
...
object StructuredLogger {
   ...
   * Slf4j Logger Object
   */
  private[this] final val logger: Logger = LoggerFactory.getLogger(classOf[LoggerToLog])
  /**
